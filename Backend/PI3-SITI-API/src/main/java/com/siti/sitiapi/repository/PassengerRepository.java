...
public class PassengerRepository implements BaseRepository {
    ...
    public void submitVote(Long passengerId, Long pollId, Long boardingStopId, Long boardingScheduleId, Long alightingStopId, Long alightingScheduleId) {
        jdbc.update(
                "INSERT INTO passenger_votes (id_passenger, poll_id, boarding_stop_id, boarding_schedule_id, alighting_stop_id, alighting_schedule_id, voted_date, status) " +
                "VALUES (?, ?, ?, ?, ?, ?, CURRENT_DATE(), 'Registrado')",
                passengerId, pollId, boardingStopId, boardingScheduleId, alightingStopId, alightingScheduleId
        );
    }
}
