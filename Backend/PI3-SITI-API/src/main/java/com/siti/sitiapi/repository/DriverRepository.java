    ...
    public Driver findById(Long id) {
        var result = jdbc.query(
                ...
                (rs, row) -> {
                    ...
                    if (cnhCategoryStr != null) {
                        String cleanCat = cnhCategoryStr.split("/")[0].trim();
                        try {
                            d.setCnhCategory(com.siti.sitiapi.enums.CNHCategoryEnum.valueOf(cleanCat));
                        } catch (Exception ex) {
                            d.setCnhCategory(com.siti.sitiapi.enums.CNHCategoryEnum.D);
                        }
                    }
